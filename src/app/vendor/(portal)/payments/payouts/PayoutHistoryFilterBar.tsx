/**
 * @fileoverview Renders the filter bar used by `/vendor/payments/payouts`.
 * @module app/vendor/(portal)/payments/payouts/PayoutHistoryFilterBar
 */
...
import type { VendorPayoutHistoryFilters } from "@/lib/vendors/payouts";
...
export function PayoutHistoryFilterBar({
  ...
  function navigate(params: URLSearchParams) {
    ...
    startTransition(() => {
      router.push(query ? `/vendor/payments/payouts?${query}` : "/vendor/payments/payouts");
    });
  }

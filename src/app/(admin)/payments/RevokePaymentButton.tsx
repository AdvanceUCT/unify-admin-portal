/**
 * @fileoverview Provides the Revoke Payment Button interaction on `/payments/applications`.
 * @module app/(admin)/payments/RevokePaymentButton
 */
...
export function RevokePaymentButton({
  action,
  applicationId,
  companyName,
}: {

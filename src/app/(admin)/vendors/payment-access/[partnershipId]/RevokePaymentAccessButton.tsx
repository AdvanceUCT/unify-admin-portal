/**
 * @fileoverview Revokes an approved vendor's payment acceptance from the detail page.
 * @module app/(admin)/vendors/payment-access/[partnershipId]/RevokePaymentAccessButton
 */
...
/**
 * Durable regardless of how APPROVED was reached — the justification-based
 * flow, and whatever replaces it, both end at the same APPROVED state, and
 * this is how it comes back off. Not isolated like PendingApplicationReview.
 */
export function RevokePaymentAccessButton({
  action,
  applicationId,
  companyName,
}: {
  ...
  return (
    <>
      ...
      >
        ...
        Revoke payment acceptance
      </button>

      <Dialog isOpen={isOpen} onClose={() => setIsOpen(false)} title="Revoke payment acceptance">
